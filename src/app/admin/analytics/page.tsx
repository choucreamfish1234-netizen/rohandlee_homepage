...
const PAGE_NAMES: Record<string, string> = {
  ...
  '/centers/property-crime': '금융사기센터', '/centers/financial-fraud': '금융사기센터', '/centers/asset-recovery': '재산회복 센터',
  '/centers/damages': '손해배상 센터', '/centers/corporate': '기업법무 센터', '/centers/it-security': '개인정보보호센터',
}
