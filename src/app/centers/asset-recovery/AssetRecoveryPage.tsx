...
const whyPoints = [
  ...
  { title: '사기 고소와 재산 회수를 동시에', desc: '금융사기센터에서 사기 형사 고소로 가해자를 압박하고, 재산회복센터에서 동시에 가압류와 강제집행을 진행합니다. 형사 압박이 들어가면 돈이 나옵니다.', centers: [{ name: '금융사기센터', path: '/centers/financial-fraud' }] },
