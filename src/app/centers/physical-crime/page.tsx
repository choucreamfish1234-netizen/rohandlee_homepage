...
export async function generateMetadata(): Promise<Metadata> {
  return getPageSeo('/centers/physical-crime', {
    ...
    keywords: '스토킹 변호사, 스토킹 접근금지, 스토킹 접근금지 가처분, 사이버 스토킹 고소, 데이트폭력 고소, 데이트폭력 자가진단, 폭행 합의금, 상해 합의금, 협박 고소 방법, 가정폭력 변호사, 가정폭력 접근금지, 공갈 고소, 감금 고소, 학교폭력 변호사, 스토킹 증거 확보, 데이트폭력 증거, 트라우마 본딩, 법률사무소 로앤이',
    ogTitle: '스토킹·데이트폭력·폭행·협박 피해 전담센터',
