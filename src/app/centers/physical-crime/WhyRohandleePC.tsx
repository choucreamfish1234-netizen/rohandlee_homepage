...
const points = [
  ...
  { title: '데이트폭력 + 금전 갈취까지 당하고 있다면?', desc: '맞으면서 돈도 뜯기고 있는 경우. 폭행 고소, 공갈 고소, 피해금 가압류, 손해배상을 동시에 진행합니다. 한 분야만 하는 로펌에서는 불가능한 대응입니다.', centers: [{ name: '금융사기센터', path: '/centers/financial-fraud' }, { name: '재산회복센터', path: '/centers/asset-recovery' }] },
