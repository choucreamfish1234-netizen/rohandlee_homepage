...
export async function generateMetadata(): Promise<Metadata> {
  return getPageSeo('/centers/sexual-crime', {
    ...
    description: '성범죄 피해자 전문 이유림 변호사. 성폭행, 성추행, 강제추행, 불법촬영, 몰카, 디지털성범죄, 리벤지포르노, 딥페이크 피해 전문 상담. 로톡 평점 4.9, 후기 600건 이상. 경찰 조사부터 재판까지 전 과정 동행. 첫 상담 무료.',
    ...
    ogDescription: '성범죄 피해자 전문 이유림 변호사. 성폭행, 성추행, 불법촬영, 디지털성범죄 피해 전문. 로톡 평점 4.9. 첫 상담 무료.',
  })
}
