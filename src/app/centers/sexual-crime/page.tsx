...
export async function generateMetadata(): Promise<Metadata> {
  return getPageSeo('/centers/sexual-crime', {
    ...
    description: '베스트셀러 《피해자 감별사회》 공동저자 이유림 변호사가 성폭행·성추행·강제추행·불법촬영·디지털성범죄·스토킹 피해자의 고소, 수사, 재판, 손해배상을 대리합니다. 첫 상담 무료.',
    ...
    ogDescription: '《피해자 감별사회》 공동저자 이유림 변호사. 성폭행·성추행·불법촬영·디지털성범죄·스토킹 피해자 대리. 첫 상담 무료.',
  })
}
