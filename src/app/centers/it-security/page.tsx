...
export async function generateMetadata(): Promise<Metadata> {
  return getPageSeo('/centers/it-security', {
    title: '디지털성범죄·딥페이크·리벤지포르노 피해자 변호사',
    description: '불법촬영, 몰카, 딥페이크, 리벤지포르노, 온라인 성착취 피해 전문. 유포 차단, 삭제 요청, 가해자 처벌, 손해배상까지. 디지털 증거 보전 및 포렌식 절차 조력. 첫 상담 무료.',
    keywords: '디지털성범죄 변호사, 딥페이크 변호사, 리벤지포르노 변호사, 불법촬영 변호사, 몰카 변호사, 온라인 성착취, 유포 차단, IT 보안 법률',
    ogTitle: '디지털성범죄·딥페이크·리벤지포르노 피해자 변호사',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '즉시 증거를 보전하고 수사기관에 신고해야 합니다. 로앤이는 전문 포렌식 업체와 협업하여 증거 확보를 조력하고, 수사 협력부터 손해배상 청구까지 법률적으로 지원합니다.',
      },
    },
    {
      '@type': 'Question',
