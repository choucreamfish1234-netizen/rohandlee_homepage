...
const steps = [
  ...
  { num: '02', title: '디지털 증거 확보', desc: '전문 포렌식 업체와 협업하여 디지털 증거를 수집·분석하고 법적 증거력을 확보합니다.' },
...
const faqs = [
  ...
  },
  {
    ...
    a: '즉시 증거를 보전하고 수사기관에 신고해야 합니다. 로앤이는 전문 포렌식 업체와 협업하여 증거 확보를 조력하고, 수사 협력부터 손해배상 청구까지 법률적으로 지원합니다.',
  },
  {
...
export default function ITSecurityCenterPage() {
  return (
    <CenterPageTemplate
      ...
      centerName="개인정보보호 법률센터"
      subtitle="개인정보보호 법률센터"
      ctaLabel="개인정보보호 법률 상담"
      ctaHref="/consultation"
      defaultCaseType="개인정보보호 법률 상담"
      services={[
        {
          title: '해킹 피해 대응',
        ...
        },
        {
          ...
          description: '전자 증거의 보전 방법을 안내하고, 전문 포렌식 업체와 협업하여 분석 결과의 법적 활용을 조력합니다.',
      ...
      declaration={{
        title: '디지털 범죄는\n디지털로 대응합니다.',
        description:
          '기술과 법률의 융합.\n로앤이 개인정보보호 법률센터가 디지털 세상의 정의를 세웁니다.',
      }}
      ...
      ctaDescription="개인정보보호 법률 전문가의 상담을 받아보세요."
    />
  )
}
