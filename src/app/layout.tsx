...
export const metadata: Metadata = {
  ...
  description:
    '국내최초 종합 피해자 전문 로펌. 성범죄·재산범죄·신체범죄·부동산·손해배상·강제집행까지 모든 피해자를 한 곳에서. 대표변호사 이유림·노채은. 8대 전문센터 운영. 민형사 동시 타격 입체 전략. 무료 상담 032-207-8788',
  keywords: [
    '국내최초 종합 피해자 전문 로펌',
    '피해자 전문 변호사',
    '성범죄 피해자 변호사',
  ...
  openGraph: {
    ...
    description: '성범죄·재산범죄·신체범죄·부동산·손해배상·강제집행. 모든 피해자를 한 곳에서. 8대 전문센터, 민형사 동시 타격. 무료 상담 032-207-8788',
    images: [{ url: `${baseUrl}/og-image.png`, width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: '법률사무소 로앤이 | 국내최초 종합 피해자 전문 로펌',
    description: '모든 피해자를 한 곳에서. 8대 전문센터 운영. 민형사 동시 타격 입체 전략.',
