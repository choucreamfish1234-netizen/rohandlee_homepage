...
export const metadata: Metadata = {
  ...
  title: {
    default: '법률사무소 로앤이 | 최초의 종합 피해자 중심 로펌',
    template: '%s | 법률사무소 로앤이',
  },
  description:
    '최초의 종합 피해자 중심 로펌. 성범죄·재산범죄·신체범죄·부동산·손해배상·강제집행까지 모든 피해를 한 곳에서. 대표변호사 이유림·노채은. 9대 전문센터 운영. 민형사 동시 타격 입체 전략. 상담 032-207-8788',
  keywords: [
    '최초의 종합 피해자 중심 로펌',
    '피해자 전문 변호사',
    '성범죄 피해자 변호사',
  ...
  openGraph: {
    ...
    url: baseUrl,
    siteName: '법률사무소 로앤이',
    title: '법률사무소 로앤이 | 최초의 종합 피해자 중심 로펌',
...
const jsonLd = {
  ...
  description: '최초의 종합 피해자 중심 로펌. 성범죄·재산범죄·신체범죄·부동산·손해배상·강제집행까지 모든 분야의 피해자를 전문으로 대리합니다.',
  url: baseUrl,
