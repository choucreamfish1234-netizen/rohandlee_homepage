...
const faqs = [
  {
    q: '피해자 전문 로펌이 뭔가요?',
    a: '피해자 전문 로펌은 범죄나 사고의 피해자만을 전문으로 대리하는 법률사무소입니다. 법률사무소 로앤이는 성범죄, 재산범죄, 신체범죄, 부동산 분쟁, 손해배상, 강제집행 등 모든 분야의 피해자를 종합적으로 대리하는 국내최초 종합 피해자 중심 로펌입니다.',
  },
  {
  ...
  },
  {
    ...
    a: '네, 가능합니다. 법률사무소 로앤이 금융사기센터와 재산회복센터가 협력하여, 사기죄 형사 고소와 동시에 가압류·강제집행으로 피해 금액을 회수합니다. 민사와 형사를 동시에 진행하는 입체 전략으로 회수 가능성을 극대화합니다.',
  },
  {
  ...
  {
    q: '상담한 변호사가 직접 사건을 맡나요?',
    a: '네. 법률사무소 로앤이는 대표변호사 이유림·노채은이 상담부터 고소장 작성, 수사기관 동행, 법원 출석, 의견서 제출, 합의 협상까지 모든 과정을 직접 수행합니다. 다른 변호사에게 사건이 넘어가지 않습니다.',
  },
  {
    q: '전국에서 상담받을 수 있나요?',
